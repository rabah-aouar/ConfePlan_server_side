# Generated by Django 3.1.7 on 2022-04-06 00:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='articles.author')),
            ],
        ),
        migrations.AddField(
            model_name='article',
            name='authors',
            field=models.ManyToManyField(through='articles.Article_____', to='articles.Author'),
        ),
        migrations.AddField(
            model_name='article',
            name='conference_id',
